...
import com.example.honball.view.AutoFitTextureView;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing == frontCamera) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture:
                ...
                break;
            case R.id.change:
                if(frontCamera == CameraCharacteristics.LENS_FACING_BACK){
                    frontCamera = CameraCharacteristics.LENS_FACING_FRONT;
                }else{
                    frontCamera = CameraCharacteristics.LENS_FACING_BACK;
                }
                closeCamera();
                openCamera(mTextureView.getWidth(), mTextureView.getHeight());
                break;
